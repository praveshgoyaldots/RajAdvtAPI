...
namespace CMOWebApi.Models.ComparetiveModel
{
	...
	public class DistrictKPIModel
	{
        ...
        public List<DistrictKPIParameterMappingModel> DistrictKPIParameterMappingModel { get; set; }
	}

	public class DistrictKPIParameterMappingModel
	{
	...
	public class DistrictKPIListViewModel
	{
		public int Id { get; set; }
		public Nullable<int> Code { get; set; }
		public Nullable<int> DepartmentCode { get; set; }
