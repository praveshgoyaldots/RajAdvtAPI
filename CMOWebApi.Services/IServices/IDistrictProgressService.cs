...
{
	public interface IDistrictProgressService
	{
		/// <summary>
		...
		/// <returns></returns>
		ServiceResponse<PagedData<DistrictProgressListViewModel>> GetAll(IndexModel model, long catCode = 0);
		...
		/// <param name="model"></param>
		/// <returns></returns>
		Task<ServiceResponse<string>> Create(DistrictProgressModel model);
		...
		/// <param name="id"></param>
		/// <returns></returns>
		ServiceResponse<DistrictProgressModel> GetById(long id);
		...
		/// <param name="model"></param>
		/// <returns></returns>
		Task<ServiceResponse<string>> Edit(DistrictProgressModel model);
		...
		/// <param name="model"></param>
		/// <returns></returns>
		ServiceResponse<DistrictProgressModel> IsDataAvailable(DistrictProgressModel model);
