...
namespace CMOWebApi.Services.Services
{
    public partial class DateTimeHelper : IDateTimeHelper
    {
        ...
        private string _StrLocalTime;
        private string _StrUTCDate;
        private string _StrUTCTime;
        public System.DateTime LocalNow
        {
            get
            {
                return _LocalNow = DateTime.Now;
            }
            set
            {
                _LocalNow = value;
        ...
        public string StrLocalDate
        {
            get
            {
                return _StrLocalDate = string.Format(EntitySettings.DateFormatRazor, DateTime.Now);
            }
            set
            {
                _StrLocalDate = value;
        ...
        public string StrLocalTime
        {
            get
            {
                return _StrLocalDate = string.Format(EntitySettings.TimeFormatRazor, DateTime.Now);
            }
            set
            {
                _StrLocalDate = value;
        ...
        public string StrUTCDate
        {
            get
            {
                return _StrLocalDate = string.Format(EntitySettings.DateFormatRazor, DateTime.UtcNow);
            }
            set
            {
                _StrLocalDate = value;
        ...
        public string StrUTCTime
        {
            get
            {
                return _StrLocalDate = string.Format(EntitySettings.TimeFormatRazor, DateTime.UtcNow);
            }
            set
            {
                _StrLocalDate = value;
        ...
        public DateTimeHelper(//IWorkContext _workContext, 
        ...
        /// e.g.,  _dateTimeHelper.ConvertToUserTime(DateTime.Now)
        /// </summary>
        ...
        /// <summary>
        /// Converts the date and time to current user date and time
        /// e.g., _dateTimeHelper.ConvertToUserTime(item.Order.CreatedOnUtc, DateTimeKind.Unspecified)
        /// e.g., _dateTimeHelper.ConvertToUserTime(item.Order.CreatedOnUtc, DateTimeKind.Utc)
        /// e.g., _dateTimeHelper.ConvertToUserTime(item.Order.CreatedOnUtc, DateTimeKind.Local)
        /// </summary>
        /// <param name="dt">The date and time (respesents local system time or UTC time) to convert.</param>
        ...
        /// <summary>
        /// Converts the date and time to current user date and time
        /// e.g., _dateTimeHelper.ConvertToUserTime(DateTime.Now, TimeZoneInfo.Local, _dateTimeHelper.DefaultStoreTimeZone);
        /// </summary>
        /// <param name="dt">The date and time to convert.</param>
        /// <param name="sourceTimeZone">The time zone of dateTime.</param>
        ...
        public virtual TimeZoneInfo CurrentTimeZone
        {
            get
            {
                return null;//get user default time zone as stored in table  GetCustomerTimeZone(_workContext.CurrentCustomer);//SystemCustomerAttributeNames.TimeZoneId
            }
            set
            {
                if (!_dateTimeSettings.AllowCustomersToSetTimeZone)
