...
var CKEditorComponent = /** @class */ (function () {
    ...
    function CKEditorComponent(zone) {
        ...
        this.filebrowserBrowseUrl = new core_1.EventEmitter();
        this.filebrowserUploadUrl = new core_1.EventEmitter();
    ...
    CKEditorComponent.prototype.ckeditorInit = function (config) {
        ...
        if (typeof CKEDITOR === 'undefined') {
          ...
          //   this.instance=CKEDITOR.replace( this.host.nativeElement, {
          //     filebrowserBrowseUrl: '/browser/browse.php',
          //     filebrowserUploadUrl: '/uploader/upload.php'
          // });
          config.filebrowserBrowseUrl = 'filebrowserUploadUrl';
          ...
          CKEDITOR.replace( 'editor1', {
            ...
            this.instance.on('fileUploadResponse', function (evt) {
             ...
             // CKEditor filebrowserUploadUrl event
             this.instance.on('filebrowserUploadUrl', function (evt) {
              _this.filebrowserUploadUrl.emit(evt);
          });
            // CKEditor filebrowserUploadUrl event
            this.instance.on('filebrowserBrowseUrl', function (evt) {
              _this.filebrowserBrowseUrl.emit(evt);
          });
    ...
    __decorate([
      core_1.Input(),
      __metadata("design:type", Object)
  ], CKEditorComponent.prototype, "filebrowserBrowseUrl", void 0);
  __decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], CKEditorComponent.prototype, "filebrowserUploadUrl", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", Object)
