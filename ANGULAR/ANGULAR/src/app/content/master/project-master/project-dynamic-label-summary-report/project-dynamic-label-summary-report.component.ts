...
import { SumOfDynamicLabelSummaryReportModel, ProjectReportFilterModel } from 'src/app/Shared/Model/Master/project-master-model';
import { MatTableDataSource, MatSort, MatDialog, DateAdapter, MAT_DATE_FORMATS } from '@angular/material';
...
@Component({
  selector: 'app-project-dynamic-label-summary-report',
  templateUrl: './project-dynamic-label-summary-report.component.html',
  styleUrls: ['./project-dynamic-label-summary-report.component.css'],
  providers: [DatePipe,
    { provide: DateAdapter, useClass: AppDateAdapter },
    { provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS },
  ]
})
export class ProjectDynamicLabelSummaryReportComponent implements OnInit {
//#region Variable
listModel: SumOfDynamicLabelSummaryReportModel[];
filterModel: ProjectReportFilterModel;
dataSource: MatTableDataSource<SumOfDynamicLabelSummaryReportModel>;
dDLList: DDLModel;
...
constructor( private _parentComponent: AppComponent,
  ...
  this._parentComponent.setpagelayout(
    "Works Entry's Dynamic Label Summary Report:",
    "",
    "",
...
ExportToExcel(){
  ...
  if (this.listModel) {
    const exportModel = new ExportToExcelModel(this.listModel, 'Works Entry Dynamic Label summary Report', 'Summary report');
...
GetList() {
  ...
  this._projectMasterService.GetSumOfDynamicLabelSummaryReport(this.filterModel).subscribe(
    data => {
      
      if (data.IsSuccess) {
        this.listModel = <SumOfDynamicLabelSummaryReportModel[]>data.Data;
        this.dataSource = new MatTableDataSource<SumOfDynamicLabelSummaryReportModel>(
          this.listModel
        );
