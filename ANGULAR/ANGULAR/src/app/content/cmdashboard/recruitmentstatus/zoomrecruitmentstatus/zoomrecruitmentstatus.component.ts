...
import { RecruitmentStatusService } from "src/app/Shared/Service/RecruitmentStatus.service";
...
@Component({
  ...
  templateUrl: "./zoomrecruitmentstatus.component.html",
  styleUrls: ["./zoomrecruitmentstatus.component.css"]
})
export class ZoomrecruitmentstatusComponent implements OnInit {
  newArray: Array<any> = [];
  ...
  constructor(
    ...
    public dialog: MatDialogRef<ZoomrecruitmentstatusComponent>,
  ...
  public drawLineChart() {
    ...
    chart = new this.gLib.visualization.LineChart(
      document.getElementById("recruitmentstatuszoomdiv")
    );
