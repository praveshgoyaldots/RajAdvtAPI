...
import { ProjectMonitoringService } from "./../../../Shared/Service/ProjectMonitoring.service";
...
import { ProjectmonitoringFilterComponent } from "./projectmonitoring-filter/projectmonitoring-filter.component";
import { ZOOMProjectmonitoringComponent } from "./zoomprojectmonitoring/zoomprojectmonitoring.component";
...
export class ProjectMonitoringComponent implements OnInit {
  ...
  public drawLineChart() {
    ...
    chart = new this.gLib.visualization.LineChart(
      document.getElementById("projectmonitoringdiv")
    );
  ...
  openZoomDialog() {
    const dialogRef = this.dialog.open(ZOOMProjectmonitoringComponent, {
      width: "95%",
      height: "95%",
      data: this.type
    });
  ...
  openDialog() {
    const dialogRef = this.dialog.open(ProjectmonitoringFilterComponent, {
      width: "500px",
