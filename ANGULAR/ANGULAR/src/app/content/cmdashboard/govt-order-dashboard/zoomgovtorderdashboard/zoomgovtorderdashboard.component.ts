...
@Component({
  ...
  templateUrl: "./zoomgovtorderdashboard.component.html",
  styleUrls: ["./zoomgovtorderdashboard.component.css"]
})
export class ZOOMgovtorderdashboardComponent implements OnInit {
  newArray: Array<any> = [];
  ...
  constructor(
    ...
    public dialog: MatDialogRef<ZOOMgovtorderdashboardComponent>,
  ...
  public drawLineChart() {
    ...
    chart = new this.gLib.visualization.LineChart(
      document.getElementById("govtorderdashboardzoomdiv")
    );
