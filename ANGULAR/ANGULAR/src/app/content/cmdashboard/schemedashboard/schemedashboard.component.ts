...
import { SchemedashboardzoomdailogComponent } from "./schemedashboardzoomdailog/schemedashboardzoomdailog.component";

@Component({
  selector: "app-schemedashboard",
  templateUrl: "./schemedashboard.component.html",
  styleUrls: ["./schemedashboard.component.css"]
})
export class SchemedashboardComponent implements OnInit {
  ...
  public drawLineChart() {
    ...
    chart = new this.gLib.visualization.LineChart(
      document.getElementById("schemedashboarddiv")
    );
  ...
  openZoomDialog() {
    const dialogRef = this.dialog.open(SchemedashboardzoomdailogComponent, {
      width: "95%",
      height: "95%",
      data: this.type
    });
