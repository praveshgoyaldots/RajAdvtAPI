...
import { CMOLetterService } from "src/app/Shared/Service/CMOLetter.service";
...
@Component({
  ...
  templateUrl: "./zoom-cmoletterdailog.component.html",
  styleUrls: ["./zoom-cmoletterdailog.component.css"]
})
export class ZoomCMOLetterdailogComponent implements OnInit {
  @Input() closable = true;
  ...
  constructor(
    ...
    public dialog: MatDialogRef<ZoomCMOLetterdailogComponent>,
  ...
  public drawLineChart() {
    ...
    chart = new this.gLib.visualization.LineChart(
      document.getElementById("cmoletterZoomdiv")
    );
