import {
  ListCMISTaskModel,
  CMISTaskModel
} from "./../../../Shared/Model/CMISTask-Model";
import { GoogleChartService } from "./../../../Shared/Service/google-chart.service";
import { CMISTaskService } from "./../../../Shared/Service/CMISTask.sercice";
import {
  MatTableDataSource,
  MatPaginator,
  MatSort,
...
import { ZoomcmistaskdailogComponent } from "./zoomcmistaskdailog/zoomcmistaskdailog.component";

@Component({
  selector: "app-cmistask",
  templateUrl: "./cmistask.component.html",
  styleUrls: ["./cmistask.component.css"],
  providers: [CMISTaskService]
})
export class CmistaskComponent implements OnInit {
  type: string = "table";
  newArray: Array<any> = [];
  ...
  private drawLineChart() {
    ...
    chart = new this.gLib.visualization.LineChart(
      document.getElementById("cmistaskchartdiv")
    );
  ...
  openZoomDialog() {
    const dialogRef = this.dialog.open(ZoomcmistaskdailogComponent, {
      width: "95%",
      height: "95%",
      data: this.type
    });
