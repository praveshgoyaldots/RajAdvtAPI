...
import { EbookletEnumProd, EbookletEnum } from '../../Enum/ebooklet.enum';
	...
	export class DistrictProgressModel {
    ...
    DistrictProgressParameterMappingModel: DistrictProgressParameterMappingModel[]= [];
	...
	export class DistrictProgressParameterMappingModel {
		Id: number;
	...
	export class DistrictProgressListViewModel {
		Id: number;
		Code: number | null;
