...
/****** Object:  View [dbo].[vwADV_AdvertisementServiceList]    Script Date: 16-12-2019 11:29:53 ******/
SET ANSI_NULLS ON
GO
...
/****************************************
Created By :paras 
Script Date : 14-12-2019
Description : To get Comma separated child table data
				for service
select * from [vwADV_AdvertisementServiceList]
********************************** *****/

 alter view [dbo].[vwADV_AdvertisementServiceList]
 as
...
and 
cast(getdate() as date) <= cast(isnull(ExpiryDate,GETDATE()) as date)
