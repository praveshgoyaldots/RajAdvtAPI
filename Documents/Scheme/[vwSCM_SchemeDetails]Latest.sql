...
,schm.TypeCode,schm.OwnedBy,lOwnedBy.lookup as OwnedByName,lSchm.lookup as ApplyForSchemeName,lmoa.lookup as MadeOfApplingName,schm.OwnedBySate,schm.OwnedByCenter,schm.IsListedRGDPSAct,schm.DeliveryTimeInDays
...
,schm.MadeOfApplingOnlineBoth,schm.DepartmentWebsiteUrl,schm.IsServiceFees,schm.HowToPayFeeCode,schm.HelplineNo
...
,schm.PaymentDisbursmentFrequencyInstallments,scmpdfi.Code as PaymentDisbursmentFrequencyInstallmentsName,schm.PaymentDisbursmentFrequencyTillAPeriod,schm.ItemDetails
,schm.CreatedDate,schm.CreatedBy,schm.ModifiedDate,schm.ModifiedBy,schm.IsActive,schm.IsDeleted,schm.Code,schm.ServiceFeeAmount
